{
    ...
    const count = (inputAmountElement, selectorCurrencyElement) =>{
    ...
    let result = 0;
        ...
        const init = () =>{
            ...
            const inputAmountElement = document.querySelector(".js-inputAmout").value;
            ...
            sectionCurrencyElement.innerText = newCurenty;
        }); 
    }
    init();
}